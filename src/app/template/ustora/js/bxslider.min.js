...
!(function(t) {
  ...
  t.fn.bxSlider = function(n) {
    ...
    let r = this
    e.el = this
    let a = t(window).width()
    let l = t(window).height()
    let d = function() {
    ...
    var c = function() {
      ...
      let e = o.children.eq(o.settings.startSlide)
      o.settings.preloadImages == 'all' && (e = o.children),
        o.settings.ticker
          ? (o.settings.pager = !1)
          : (o.settings.pager && T(),
    ...
    var g = function(e, i) {
      const s = e.find('img, iframe').length
      if (s == 0) {
        return i(), void 0
      }
      let n = 0
    ...
    var h = function() {
      ...
      o.loader.remove(),
        S(),
        o.settings.mode == 'vertical' && (o.settings.adaptiveHeight = !0),
        o.viewport.height(v()),
        r.redrawSlider(),
    ...
    var v = function() {
      ...
      if (o.settings.mode == 'vertical' || o.settings.adaptiveHeight) {
        if (o.carousel) {
          let n =
            o.settings.moveSlides == 1 ? o.active.index : o.active.index * m()
          for (
    ...
    var f = function() {
      let t = 1
      if (o.settings.mode == 'horizontal' && o.settings.slideWidth > 0) {
        if (o.viewport.width() < o.minThreshold) {
          t = o.settings.minSlides
        } else if (o.viewport.width() > o.maxThreshold) {
          t = o.settings.maxSlides
        } else {
          let e = o.children.first().width()
          t = Math.floor(o.viewport.width() / e)
        }
      } else {
        o.settings.mode == 'vertical' && (t = o.settings.minSlides)
      }
      return t
    }
    var x = function() {
      ...
      if (o.settings.moveSlides > 0) {
        if (o.settings.infiniteLoop) {t = o.children.length / m()}
          ...
          {for (let e = 0, i = 0; e < o.children.length; )
            ++t,
              (e = i + f()),
    ...
    var S = function() {
      if (
        ...
        if (o.settings.mode == 'horizontal') {
          const t = o.children.last()
          var e = t.position()
          b(-(e.left - (o.viewport.width() - t.width())), 'reset', 0)
        } else if (o.settings.mode == 'vertical') {
          const i = o.children.length - o.settings.minSlides
          var e = o.children.eq(i).position()
          b(-e.top, 'reset', 0)
        }
      } else {
        ...
        o.active.index == x() - 1 && (o.active.last = !0),
          void 0 != e &&
            (o.settings.mode == 'horizontal'
              ? b(-e.left, 'reset', 0)
              : o.settings.mode == 'vertical' && b(-e.top, 'reset', 0))
      }
    }
...
(a[o.animProp] = t),
          e == 'slide'
            ? r.animate(a, i, o.settings.easing, () => {
                D()
              })
            : e == 'reset'
            ? r.css(o.animProp, t)
            : e == 'ticker' &&
              r.animate(a, speed, 'linear', () => {
    ...
    var q = function(e) {
      let i = o.children.length
      return o.settings.pagerType == 'short'
        ? (o.settings.maxSlides > 1 &&
      ...
      if (o.settings.infiniteLoop) {
        ...
        o.active.index == 0
          ...
          t &&
            (o.settings.mode == 'horizontal'
              ? b(-t.left, 'reset', 0)
              : o.settings.mode == 'vertical' && b(-t.top, 'reset', 0))
      }
      ;(o.working = !1),
    ...
    var L = function() {
      let e = 0
      if (o.settings.autoDirection == 'next') {
        r.append(o.children.clone().addClass('bx-clone'))
      } else {
        r.prepend(o.children.clone().addClass('bx-clone'))
        const i = o.children.first().position()
        ...
        o.settings.tickerHover &&
          ...
          o.viewport.hover(
            ...
            () => {
              ...
              let i = o.settings.speed / e
                  var s = o.settings.mode == 'horizontal' ? 'left' : 'top'
                  var n = i * (e - Math.abs(parseInt(r.css(s))))
              N(n)
            }
          ),
        N()
    ...
    var N = function(t) {
      ...
      let e = { left: 0, top: 0 }
      var i = { left: 0, top: 0 }
      o.settings.autoDirection == 'next'
        ? (e = r
            .find('.bx-clone')
            .first()
            .position())
        : (i = o.children.first().position())
      const s = o.settings.mode == 'horizontal' ? -e.left : -e.top
      var n = o.settings.mode == 'horizontal' ? -i.left : -i.top
      var a = { resetValue: n }
      b(s, 'ticker', speed, a)
    }
    var O = function() {
...
(o.touch.start.x = e.changedTouches[0].pageX),
    ...
    var Y = function(t) {
      const e = t.originalEvent
      var i = Math.abs(e.changedTouches[0].pageX - o.touch.start.x)
      let s = Math.abs(e.changedTouches[0].pageY - o.touch.start.y)
      if (
        (3 * i > s && o.settings.preventDefaultSwipeX
          ? t.preventDefault()
          : 3 * s > i && o.settings.preventDefaultSwipeY && t.preventDefault(),
        o.settings.mode != 'fade' && o.settings.oneToOneTouch)
      ) {
        let n = 0
        if (o.settings.mode == 'horizontal') {
    ...
    var V = function(t) {
      ...
      if (
        ...
        o.settings.mode == 'horizontal'
          ...
          !o.settings.infiniteLoop &&
          ((o.active.index == 0 && s > 0) || (o.active.last && s < 0))
            ? b(i, 'reset', 200)
            : Math.abs(s) >= o.settings.swipeThreshold
            ? (s < 0 ? r.goToNextSlide() : r.goToPrevSlide(), r.stopAuto())
            : b(i, 'reset', 200)
      }
    ...
    return (
      (r.goToSlide = function(e, i) {
        if (!o.working && o.active.index != e) {
          if (
            ...
            (o.active.index = e < 0 ? x() - 1 : e >= x() ? 0 : e),
            ...
            if (!o.settings.infiniteLoop && o.carousel && o.active.last) {
              if (o.settings.mode == 'horizontal') {
                ...
                const l = o.children.length - o.settings.minSlides
                n = o.children.eq(l).position()
              }
            } else if (o.carousel && o.active.last && i == 'prev') {
              const d =
                o.settings.moveSlides == 1
                  ? o.settings.maxSlides - m()
                  : (x() - 1) * m() - (o.children.length - o.settings.maxSlides)
              var a = r.children('.bx-clone').eq(d)
              n = a.position()
            } else if (i == 'next' && o.active.index == 0) {
              (n = r
                .find('> .bx-clone')
            ...
            if (typeof n !== 'undefined') {
              const g = o.settings.mode == 'horizontal' ? -(n.left - s) : -n.top
      ...
      (r.goToNextSlide = function() {
        if (o.settings.infiniteLoop || !o.active.last) {
          const t = parseInt(o.active.index) + 1
          r.goToSlide(t, 'next')
        }
      }),
      ...
      (r.startAuto = function(t) {
        o.interval ||
          ...
          o.settings.autoControls && t != 1 && A('stop'))
      }),
      (r.stopAuto = function(t) {
        o.interval &&
          (clearInterval(o.interval),
          (o.interval = null),
          o.settings.autoControls && t != 1 && A('start'))
      }),
